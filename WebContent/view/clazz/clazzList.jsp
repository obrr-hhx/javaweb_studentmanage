...
<head>
	...
	$(function() {	
	    ...
	    $('#dataList').datagrid({ 
	        ...
	        fit: true,//自动大小 
	        method: "post",
	        url:"ClassServlet?method=ClazzDetailList&t="+new Date().getTime(),
	        idField:'id', 
	        ...
	        columns: [[  
				{field:'chk',checkbox: true,width:50},
 		        ...
 		        {field:'info',title:'班级信息',width:100},
	 		]], 
	        toolbar: "#toolbar"
	    }); 
	    //设置分页控件 
	    ...
	    $("#delete").click(function(){
        	...
        	if(selectRow == null){
            	...
            	$.messager.confirm("消息提醒", "将删除班级相关的所有数据(若班级下存在学生或教师则不能删除)，确认继续？", function(r){
            		if(r){
            			$.ajax({
							type: "post",
							url: "ClassServlet?method=DeleteClazz",
	    	...
	    	buttons: [
	    		{
					...
					handler:function(){
						...
						if(!validate){
							...
							$.ajax({
								type: "post",
								url: "ClassServlet?method=AddClazz",
	    	...
	    	buttons: [
	    		{
					...
					handler:function(){
						...
						if(!validate){
							...
							$.ajax({
								type: "post",
								url: "ClassServlet?method=EditClazz",
    	...
    	<form id="addForm" method="post">
	    	<table cellpadding="8" >
	    		...
	    		<tr>
	    			<td>班级介绍:</td>
	    			<td>
	    				<textarea id="add_info" name = "info" style="width: 200px; height: 60px;"></textarea>
	    			</td>
	    		</tr>
	    	</table>
	    </form>
